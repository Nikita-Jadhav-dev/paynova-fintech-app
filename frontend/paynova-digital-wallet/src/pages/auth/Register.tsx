    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-background">
      <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md space-y-8">
        <div className="text-center">
          ...
          <p className="text-muted-foreground text-sm mt-1">Start your PayNova journey</p>
        </div>
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          <div className="glass-card p-5 space-y-4">
            <div className="relative">
              ...
              <Input placeholder="Full name" value={name} onChange={(e) => setName(e.target.value)} className="pl-10 rounded-xl h-12 bg-muted/50 border-transparent" />
            </div>
            <div className="relative">
